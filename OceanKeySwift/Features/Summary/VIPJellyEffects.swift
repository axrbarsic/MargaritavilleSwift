...
extension View {
    /// Единый монолитный warp: сначала растеризуем ячейку вместе с контентом,
    /// затем деформируем один слой. Контур и текст двигаются как один объект.
    @ViewBuilder
...
struct VIPJellyCellShape: Shape {
