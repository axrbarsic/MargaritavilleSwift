...
struct DeepSeekLabSection: View {
    ...
    @State private var backupDocument: MargaritavillePresetBackupDocument?
    @State private var backupFilename = MargaritavillePresetBackupDocument.filename()
    ...
    var body: some View {
        ...
        .fileExporter(
            ...
            contentType: .margaritavillePresetBackup,
    ...
    private func exportBackup() {
        ...
        presetStore.load()
        let exportedAt = Date()
        let payload = MargaritavillePresetBackupPayload.make(
            presets: presetStore.presets,
            appSettings: appSettings,
            exportedAt: exportedAt
        )
        backupDocument = MargaritavillePresetBackupDocument(payload: payload)
        backupFilename = MargaritavillePresetBackupDocument.filename(exportedAt: exportedAt)
